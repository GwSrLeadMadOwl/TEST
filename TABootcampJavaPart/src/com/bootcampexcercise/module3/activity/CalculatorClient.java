...
public class CalculatorClient {
    public static void main(String[] args) {
        ...
        int res = normalCalc.multiply(mul);
        System.out.println("2) Multiplication result is " + res);
        ...
        int res2 = normalCalc.divide(10, 2);
        System.out.println("3) Division result is " + res2);
        ...
        int res3 = normalCalc.subtract(10,2);
        System.out.println("4) Subtraction result is " + res3);
    }
}
